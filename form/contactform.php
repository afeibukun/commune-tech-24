...
if(isset($_POST['email']) && !empty($_POST['email'])){
		...
		$to = "swiftsolng@gmail.com";
		$mail_subject = "Commune Tech Camp Feedback - From $name | Message ID ".$timestamp_capture;
		$mail_message = "
		<br>
		<p>Here is a feedback from the Commune Tech Camp Platform. The details are as below:</p>
		<br>
